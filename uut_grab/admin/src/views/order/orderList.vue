    ...
    <div>
        <el-form :inline="true" :model="queryData" class="demo-form-inline">
            <el-form-item label="用户ID">
                <el-input v-model="queryData.user_id" style="width:120px" clearable placeholder="ID"></el-input>
            </el-form-item>
            <el-form-item label="订单号">
                <el-input v-model="queryData.order_no" clearable placeholder="订单号"></el-input>
            </el-form-item>
        ...
        <el-table v-loading="loading" :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="price" align="center" label="商品价钱"></el-table-column>
            <el-table-column prop="item" align="center" label="商品数量"></el-table-column>
            <el-table-column prop="earn" align="center" label="订单收益"></el-table-column>
            <el-table-column label="状态" align="center">
                <template slot-scope="scope">
                    <el-tag v-if="scope.row.status === 1" size="small" type="info">已冻结</el-tag>
                    <el-tag v-if="scope.row.status === 2" size="small" type="success">已完成</el-tag>
                </template>
            </el-table-column>
            <el-table-column prop="goods_id" align="center" label="商品ID"></el-table-column>
