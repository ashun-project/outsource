    ...
    <div>
        <el-form :inline="true" :model="queryData" class="demo-form-inline">
            ...
            <el-form-item label="用户类型">
                <el-select v-model="queryData.filterTest" placeholder="请选择">
                    <el-option label="真实用户" :value="true"></el-option>
                    <el-option label="所有用户" :value="false"></el-option>
                </el-select>
            </el-form-item>
        ...
        <el-table v-loading="loading" :data="tableData" border style="width: 100%">
            ...
            <el-table-column prop="parent_top" align="center" label="帐号类型">
                <template slot-scope="scope">
                    <el-tag v-if="scope.row.parent_top === '999999'" type="danger">测试帐号</el-tag>
