...
router.post('/admin/addSubAmount', function (req, res, next) {
    ...
    var infoData = [[obj.handleAMount, 'DWD平台', 'DWD' + orderNo, obj.id, 1, 0, new Date(), obj.as_type, obj.parent_top]];
    if (obj.type === '2') {
        ...
        infoData = [[obj.handleAMount, obj.id, 'DWD' + orderNo, 1, 0, '暂无', '暂无', '暂无', 'DWD平台', new Date(), obj.as_type, obj.parent_top]];
    }
    poolUser.getConnection(function (err, conn) {
