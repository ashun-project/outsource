        ...
        <el-row style="height: 100%;">
            <el-col :span="4" class="menu-box">
                ...
                <el-menu
                    ...
                    <el-menu-item index="/rechargeList">
                    ...
                    <el-menu-item v-if="account == 'admin'" index="/userList">
            ...
            <el-col class="content-box">
                ...
                <div class="cont-top">
                    ...
                    <div class="account">
                        <div v-if="account !== 'admin'" class="current-money">
                            当前余额：
                            <span>{{isAmount}}元</span>
                        </div>
...
export default {
    ...
    computed: {
        isAmount () {
            return this.$store.state.user.amount;　　//需要监听的数据
        }
    },
    watch: {
        '$route' (to, from) {
