        ...
        <el-row style="height: 100%;">
            <el-col :span="4" class="menu-box">
                ...
                <el-menu
                    ...
                    <el-menu-item index="/commentExamineList">
                    ...
                    <el-menu-item index="/dzList">
                        <i class="el-icon-thumb"></i>
                        <span slot="title">点赞列表</span>
                    </el-menu-item>
                    ...
                    <el-menu-item index="/tuList">
                        ...
                        <span slot="title">下载图片</span>
                    </el-menu-item>
                    <el-menu-item index="/tuDownedList">
                        <i class="el-icon-finished"></i>
                        <span slot="title">已下载列表</span>
                    </el-menu-item>
                </el-menu>
            </el-col>
                    ...
                    <div class="account">
                        <el-dropdown @command="handleCommand">
                            <span class="el-dropdown-link">
                               ...
                               <span>{{account}}<i class="el-icon-arrow-down el-icon--right"></i></span>
                            </span>
...
export default {
    ...
    created() {
        ...
        //     this.$http.post('/admin/loginInfo', {account: this.account}).then(response => {
    ...
    methods: {
        ...
        handleCommand() {
            this.$http.post('/admin/loginOut').then(response => {
